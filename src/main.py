...
# Configuracion de logs (nivel INFO para diagnostico en produccion)
...
async def health_check():
    # Si el switch de salud esta desactivado, se retorna error 500
